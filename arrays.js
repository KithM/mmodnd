...
const items = [
    ...
    { name: 'Grandstaff',       itemType: 'Magic', minDamage: 1, maxDamage: 4, slot: 'Two-Handed', primaryStats: ['Intellect'], p: 0.10 },
...
const lootTypes = [
    ...
    { name: `Metallic`,            enchants: metalenchants,    p: 0.30, m: 5.000,  level: 13, validTypes: ['Melee', 'Head','Chest','Legs','Feet','Belt'] },
    { name: `Seeker`,              enchants: fiberenchants,    p: 0.29, m: 7.500,  level: 15, validTypes: ['Melee','Magic', 'Head','Chest','Legs','Feet','Belt'] },
    { name: `Warlord`,             enchants: metalenchants,    p: 0.27, m: 10.00,  level: 20, validTypes: ['Melee', 'Head','Chest','Legs','Feet','Belt'] },
    { name: `Vampiric`,            enchants: fiberenchants,    p: 0.25, m: 12.50,  level: 20, validTypes: ['Melee','Magic', 'Head','Chest','Legs','Feet','Belt'] },
    { name: `Iceshield`,           enchants: platedenchants,   p: 0.22, m: 15.00,  level: 25, validTypes: ['Head','Chest','Legs','Feet','Belt'] },
    { name: `Enchanted`,           enchants: fiberenchants,    p: 0.21, m: 18.00,  level: 25, validTypes: ['Melee','Magic'] },
    { name: `Platinum`,            enchants: platedenchants,   p: 0.20, m: 20.00,  level: 35, validTypes: ['Melee','Head','Chest','Legs','Feet','Belt'] },
    { name: `Oladium`,             enchants: platedenchants,   p: 0.17, m: 27.00,  level: 40, validTypes: ['Melee', 'Head','Chest','Legs','Feet','Belt'] },
    ...
    { name: `Ancient`,             enchants: platedenchants,   p: 0.01, m: 75.00,  level: 85, validTypes: ['Melee','Magic', 'Head','Chest','Legs','Feet','Belt'] },
